(function() {
  ...
  .controller('DayViewDialogController', DayViewDialogController);

  DayViewDialogController.$inject = ['$scope', '$interval', '$timeout', '$mdDialog', 'dataservice', 'task']

  function DayViewDialogController ($scope, $interval, $timeout, $mdDialog, dataservice, task) {
    var self = this;
    self.hide            = hide;
    self.cancel          = cancel;
    self.answer          = answer;
    ...
    function save(item) {
      console.log('DayViewDialogController:  save task clicked');
